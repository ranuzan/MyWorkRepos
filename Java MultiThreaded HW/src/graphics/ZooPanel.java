...
public class ZooPanel extends JPanel implements ActionListener, Runnable {
	...
	synchronized public void addDialog() {
		...
		switch (n) {
		case 0: // Herbivore
			dial = new AddAnimalDialog(this, "herbivore", herbivore);
			dial.setVisible(true);
			break;
		case 1: // Omnivore
			dial = new AddAnimalDialog(this, "omnivore", omnivore);
			dial.setVisible(true);
			break;
		default: // Carnivore
			dial = new AddAnimalDialog(this, "carnivore", carnivore);
			dial.setVisible(true);
			break;
		}
